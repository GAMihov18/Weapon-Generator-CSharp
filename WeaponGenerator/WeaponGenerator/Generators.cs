...
namespace WeaponGeneration
{
    public struct WEAPON_VALUE
    {
        ...
        public static string StringConvert(WEAPON_VALUE.TYPE type)
        {
            switch (type)
            {
                case TYPE.KNIFE:
        ...
        public static string StringConvert(WEAPON_VALUE.RARITY rarity)
        {
            switch (rarity)
            {
                case RARITY.COMMON:
        ...
        public static string StringConvert(WEAPON_VALUE.DAMAGE_TYPE.MAIN dType)
        {
            switch (dType)
            {
    ...
    class Weapon
    {
        ...
        {
            name = $"{WEAPON_VALUE.StringConvert(rarity)} {WEAPON_VALUE.StringConvert(weaponType)} of {WEAPON_VALUE.StringConvert(mainDamageType)}";
        }
        public string GetWeaponData(bool readable)
        {
            if (readable)
            {
                return $"Name: {name}\nAssembly Damage:{assemblyDamage:f2}\nPhysical Damage:{physicalDamage:f2}\nMagical Damage:{magicalDamage:f2}\nCrit Mult: {critMult:p}\nCrit Rate: {critRate:p}\nRarity: {WEAPON_VALUE.StringConvert(rarity)}\nWeapon Type: {WEAPON_VALUE.StringConvert(weaponType)}\nMain Damage Type: {WEAPON_VALUE.StringConvert(mainDamageType)}\nPhysical Damage: {WEAPON_VALUE.StringConvert(physicalDamageType)}\nMagical Damage: {WEAPON_VALUE.StringConvert(magicalDamageType)}\n";
            }
            else
            {
                return $"{name}:{assemblyDamage:f2}:{physicalDamage:f2}:{magicalDamage:f2}:{critMult:p}:{critRate:p}:{WEAPON_VALUE.StringConvert(rarity)}:{WEAPON_VALUE.StringConvert(weaponType)}:{WEAPON_VALUE.StringConvert(mainDamageType)}:{WEAPON_VALUE.StringConvert(physicalDamageType)}:{WEAPON_VALUE.StringConvert(magicalDamageType)}\n";
            }
        }
